...
//            }
    ...
    * @param player_username  = the username used to log into the application
    ...
    public ArrayList<Cryptograms> displayPriorGames1(String username)
    {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor priorgames_cursor = db.rawQuery(displayPriorGamesQuery,null);
        ArrayList<Cryptograms> priorgames_list = new ArrayList<>();
        ...
        if(priorgames_cursor.moveToFirst())
        {
            do {
                ...
                Cryptograms priorcrypt = new Cryptograms(id,puzzle,userText,sbstaus,true);
